...
public class SessaoTest {
	...
	public void testListarSessoesSucesso() {
		...
		try {
			...
			fail();
		} catch (HorarioNaoPermitidoException e) {//Não previa essa exceção.
			fail();
		}
		...
		} catch (CinemaNuloException e) {// Não previa essa exceção.
			fail();
		} catch (SalaNulaException e) {// Não previa essa exceção.
			fail();
		} catch (CinemaNaoEncontradoException e) {// Não previa essa exceção.
			fail();
		} catch (SalaNaoEncontradaException e) {// Não previa essa exceção.
			fail();
		}
	}
	...
	public void testCadastrarSessaoSucesso() {
		...
		Iterador i2 = salaTeste.getListaSessoes().iterador();// era salaTeste.getSessoes().iterador().
		sessao = null;
		while(i2.temProximo()){
		...
		i2 = salaTeste.getListaSessoes().iterador();// era salaTeste.getSessoes().iterador().
		sessao = null;
		while(i2.temProximo()){
			sessao = (Sessao)i2.obterProximo();
		}
	...
	public void testAlterarSessaoSucesso() {
		...
		try {
			...
			/*} catch (SessaoNulaException e1) { Não pode lançar esse tipo de exceção e sim o de CampoObrigatorioInexistenteException().
			fail();*/
		} catch (CinemaNaoEncontradoException e) {
			fail();
		} catch (IntervaloMinimoInsuficienteException e) {
			...
			fail();
		} catch (CampoObrigatorioInexistenteException e) {//Não previa essa exceção.
			fail();
		} catch (SessaoNaoEncontradaException e) {//Não previa essa exceção.
			fail();
		}
	...
	public void testAlterarSessaoComHorarioZerado() {
		...
		try{
			...
			fail();
			//}
			/*catch(SessaoNulaException cause){ Não pode lançar esse tipo de exceção e sim o de CampoObrigatorioInexistenteException().
			assertTrue(true);*/
		} catch (CinemaNaoEncontradoException e) {
			fail();
		} catch (IntervaloMinimoInsuficienteException e) {
	...
	public void testAlterarSessaoComIntervaloMinimoInsuficiente() {
		...
		try{
			...
			assertTrue(true);
			/*} catch (SessaoNulaException e) { Não pode lançar esse tipo de exceção e sim o de CampoObrigatorioInexistenteException().
			fail();*/
		} catch (CinemaNaoEncontradoException e) {
			fail();
		} catch (SalaNaoEncontradaException e) {
